<?php
namespace CPath\Framework\Render\Layout\Common\API;
...
use CPath\Framework\Render\Layout\Common\SimpleLayout;
...
class APIView extends SimpleLayout implements IRenderAll, IAPI {
