...
use CPath\Framework\Render\Fragment\Common\ModelResultsTableFragment;
...
class CPathDefaultTheme implements ITheme {
    ...
    function addHeadElementsToView(IContainerDEL $View) {
        ...
        $Head->writeStyleSheet($basePath . 'assets/cpathdefaulttheme.css', true);
        $Head->writeScript($basePath . 'assets/cpathdefaulttheme.js', true);
