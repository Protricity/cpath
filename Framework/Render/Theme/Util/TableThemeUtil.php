 ...
 * Date: 4/06/11 */
namespace CPath\Framework\Render\Theme\Util;
...
//    }
     ...
     * @param String|\CPath\Framework\Render\Attribute\IAttributes|Null $Attr optional attributes for this element
     * @return void
     */
    ...
    function renderRowStart($flags = 0, $Attr = null) {
        $Attr = \CPath\Framework\Render\Attribute\Attr::get($Attr);
        switch($this->mLastElm) {
            case 'table': break;
            case 'tr':
                $this->renderRowEnd();
